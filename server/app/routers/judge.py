...
输出 JSON:{"score": 0到100的整数, "summary": "总评,写给访客看,60字以内", "reasons": ["维度1评语,30字以内", "维度2评语,30字以内", "维度3评语,30字以内"]}
只输出 JSON,不要其他文字,严格遵守字数上限。评分要苛刻:泛泛寒暄给不到 60 分;70 分以上意味着你真心认为两人和真人也聊得来。"""
